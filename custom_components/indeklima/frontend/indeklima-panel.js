        ...
        <div class="room-card status-${r.status}"
          ...
          <div class="room-windows">
            ...
            ${r.internal_doors_open > 0
              ...
              : ""}
            ${r.mold_risk && r.mold_risk !== "low"
              ? `<span class="room-window-chip" style="color:${this._moldColor(r.mold_risk)};background:${this._moldColor(r.mold_risk)}1a;">${this._moldIcon(r.mold_risk)} ${this._moldLabel(r.mold_risk)}</span>`
              : ""}
